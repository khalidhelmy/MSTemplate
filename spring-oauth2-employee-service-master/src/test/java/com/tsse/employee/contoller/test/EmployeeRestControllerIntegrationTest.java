...
public class EmployeeRestControllerIntegrationTest {
   ...
   /* 	
        ...
        try {
			Mockito.when(service.getEmployeeAndDepartment(3L))
			.thenReturn(alex);
        ...
        Mockito.when(service.getEmployeesAndDepartment( "ASC", "firstName"))
        .thenReturn(emps);
    }
    ...
    public void givenEmployees_whenGetEmployee_thenReturnJsonObject()
      throws Exception {
        
     
        mvc.perform(get("/api/employees/3")
    ...
    public void givenEmployees_whenGetEmployees_thenReturnJsonArray()
      throws Exception {
        ...
        mvc.perform(get("/api/employees?orderBy=firstName&direction=ASC")
          .contentType(MediaType.APPLICATION_JSON))
          .andExpect(status().isOk())
          //.andExpect(jsonPath("$", hasSize(1)));
         .andExpect(jsonPath("$._embedded.employeeList[0].firstName", is("Alex")));
    ...
    @Test
    public void authenticatedWithFraudUser()
      throws Exception {
        ...
        mvc.perform(get("/api/employees")
          ...
          //.andExpect(jsonPath("$", hasSize(1)));
         //.andExpect(jsonPath("$._embedded.employeeDOList[0].employee.firstName", is("Alex")));
    }
}